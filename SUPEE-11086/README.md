***Magento SUPEE-11086*** contains multiple security enhancements that help close cross-site scripting (XSS), Remote Code Execution(RCE), cross-site request forgery (CSRF) and other vulnerabilities.
